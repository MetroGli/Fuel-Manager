...
public class ProfileActivity extends AppCompatActivity {
    ...
    /* ── Rellena los campos con los datos de sesión ─────── */
    ...
    /* ── Guarda el nombre en SQLite y SharedPreferences ─── */
    private void saveName() {
        ...
        boolean ok = db.updateUserName(userId, newName);

        if (ok) {
            // Reflejar el cambio en SharedPreferences (SessionManager)
